...
<body>
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li><a href="#" title="Location de bureaux équipés">Location de bureaux équipés</a></li>
                    ...
                    <li><a href="#" title="Votre bureau virtuel">Votre bureau virtuel</a></li>

                    <li><a href="#" title="Carte de notre réseau">Carte de notre réseau</a></li>

                    <li><a href="#" title="Location de bureaux meublés">Location de bureaux meublés</a></li>

                    <li><a href="#" title="Formulaire renseignements">Formulaire renseignements</a></li>

                    <li><a href="#" title="Adhésion réseau">Adhésion réseau</a></li>
                </ul>
            </div>
            ...
            <div class="col-sm-9 col-md-10">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-4">
                        <h3>Nos 32 points d'implantation</h3>
    ...
    </div><script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxjyyNSsrXBEJbsUpPrVcxdGcGebHsvdE">
</script><?php echo $this->Html->script('map'); ?><script type="text/javascript">
